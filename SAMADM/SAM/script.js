...
$(document).ready(function(){
  ...
  $("#serviceList").click(function(){
    $("#serviceListContent").html('<center><div class="modal-body"><img src="https://ucarecdn.com/46222ab7-e3e8-46ee-a293-752d5927f001/loader.gif" border="0" alt="loading"></div></center>');
  ...
  $('#modalDiv').on('show.bs.modal', function(e) {
    $("#modalContent").html('<center><div class="modal-body"><img src="https://ucarecdn.com/46222ab7-e3e8-46ee-a293-752d5927f001/loader.gif" border="0" alt="loading"></div></center>');
