...
<div class="container-fluid">
        ...
        <li class="pull-right custom-search">
            <form class="form-inline" action="<?=site_url("admin/tasks")?>" method="get">
                <div class="input-group">
                    <input type="text" name="search" class="form-control" value="<?=$search_word?>" placeholder="Buscar...">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Histórico de Pedidos Cancelados</h6>
        </div>
        <div class="table-responsive">
            <table class="table" style="border:1px solid #ddd">
                <thead>
                <tr>
                    <th>ID de Cancelamento</th>
                    <th>ID do Pedido</th>
                    <th>Usuário</th>
                    <th>Serviço</th>
                    <th>Link</th>
                ...
                <form id="changebulkForm" action="<?php echo site_url("admin/tasks/multi-action") ?>" method="post">
                    ...
                    <?php foreach( $orders as $order ): ?>
                        <tr>
                            ...
                            <td>Cancelamento</td>
                            <td><?php if($order["task_status"] == "pending"): echo "Aguardando Cancelamento"; elseif($order["task_status"] == "success"): echo "Confirmado"; elseif($order["task_status"] == "canceled"): echo "Negado"; endif; ?></td>
