<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
	...
	<div class="settings-header__table">
		<button type="button" class="btn btn-default m-b" data-toggle="modal" data-target="#modalDiv" data-action="add_currency">Adicionar Moeda</button>
	</div>
	
	
	 <div class="alert alert-primary" role="alert">
<strong><span style="color:#15184A;">
Nota: Se você adicionar qualquer moeda cuja taxa é desconhecida para você, você pode inserir '1' como a taxa e clicar no botão 'Taxa de moeda automática' para obter as taxas atuais. Esta etapa é obrigatória. Certifique-se de clicar em 'Auto Rate Updater' para atualizar a taxa de conversação do serviço.</p></div>
   ...
   <table class="table report-table" style="border:1px solid #ddd">
      <thead>
         <tr>
            <th> Nome </th>
                        <th>Atualização da taxa câmbio</th>
 ...
 <?php endif;?>
             <td class="text-right col-md-1">
              <div class="dropdown pull-right">
                <button type="button" class="btn btn-default btn-xs dropdown-toggle btn-xs-caret" data-toggle="dropdown">Opçães <span class="caret"></span></button>
                <ul class="dropdown-menu">
                  <li>
                <a  data-toggle="modal" data-target="#modalDiv" data-action="edit_currency" data-id="<?= $currencie["id"] ?>">Editar</a>
