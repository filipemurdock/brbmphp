<div class="col-md-8">
    ...
    <div class="panel panel-default">
        ...
        </div><center><h4>Adicione a cron jobs para 1 minuto</h4></center>
       <hr>
<div class="row">
    <div class="form-group col-md-12">
        <label class="control-label">Cron URL:</label>
        <input type="text" class="form-control" disabled value="<?= URL."/SAMJOBS.php?token=". $keys_key_moto ?>">
    </div>
</div>
<hr>
       <hr>
<div class="row">
    <div class="form-group col-md-12">
        <label class="control-label">Adicione esse comando <strong>Cpanel</strong></label>
        <input type="text" class="form-control" disabled value="curl —silent <?= URL."/SAMJOBS.php?token=". $keys_key_moto ?> >/dev/null 2>&1">
    </div>
</div>
<hr>
       <hr>
<div class="row">
    <div class="form-group col-md-12">
        <label class="control-label">Adicione esse comando <strong>Hostiger Hpanel</strong></label>
        <input type="text" class="form-control" disabled value="curl -v '<?= URL."/SAMJOBS.php?token=". $keys_key_moto ?>'">
    </div>
</div>
<hr>
<div class="row">
    <div class="form-group col-md-12">
        <p><label class="control-label">Sync Manual</label></p>
        <a class="btn btn-primary" href="<?= URL."/SAMJOBS.php?token=". $keys_key_moto ?>" target="_blank">Sincronizar</a>
    </div>
</div>
<!--<div class="col-md-12 help-block">-->
<!--    <small><i class="fa fa-warning"></i> <code>Cron Key</code> Por favor, escreva sua chave de API na seção de senha.</small>-->
<!--    <small>Preste atenção aos caracteres turcos ao escrever o título do SMS.</small>-->
<!--</div>-->
