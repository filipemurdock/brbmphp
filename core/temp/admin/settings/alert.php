...
<hr>
        ...
        <div class="row">
          ...
          <div class="form-group col-md-6">
             <label for="smtp_pass" class="control-label">Senha SMTP:</label>
    <input type="password" id="smtp_pass" name="smtp_pass" class="password-input" value="<?=$settings["smtp_pass"]?>">
    <button type="button" class="btn btn-secondary active" onclick="togglePassword('smtp_pass')" disabled>Mostrar/Esconder Senha </button>
...
window.addEventListener('DOMContentLoaded', function() {
    var smtpPassInput = document.getElementById("smtp_pass");
