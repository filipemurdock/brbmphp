...
<div class="col-md-2 col-md-offset-1">
            <ul class="nav nav-pills nav-stacked p-b">
                              ...
                              <li class="settings_menus "><a href="<?=site_url("admin/appearance/language")?>">Languages</a></li>
                               <li class="settings_menus "><a href="<?=site_url("admin/appearance/files")?>">Pastas</a></li>
                          </ul>
          </div>
<div class="container">
                <div class="row">
                ...
                <div class="row">
                   <div class="col-md-12">
                    <div class="theme-edit-block">
                      ...
                      Documento será adicionado em breve...<br>
                      Você pode acessar os códigos de tema da página que deseja editar do lado esquerdo.
                      </div>
                    </div>
                  </div>
                  </div>
               ...
               <div class="panel-body">
                ...
                <form action="<?php echo site_url("admin/appearance/themes/".$theme["theme_dirname"]."?file=".$lyt) ?>" method="post" class="twig-editor__form">
                  ...
                  <div class="edit-theme-body-buttons text-right">
                    <button class="btn btn-primary click">Atualizar</button>
                  </div>
                </form>
