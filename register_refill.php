...
try {
    ...
    $order_url = $data->order_url; // Obtendo o proxy URL
    ...
    if ($order) {
        $client_id = $order['client_id'];  // Aqui está a linha adicionada
        ...
        if ($service) {
            ...
            $service_name = $service['service_name'];  // Aqui está a linha adicionada
            ...
            if ($refill_count >= $max_refills) {
                ...
                $stmt->bindParam(':order_url', $order_url); // Inserir o proxy URL
